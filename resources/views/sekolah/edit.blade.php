...
@section('container')
    <div class="p-4 bg-white rounded-lg shadow-md">
        ...
        <div class="mt-5">
            <p class="text-md font-bold">Form Edit Data Sekolah</p>
            <form method="post" action="{{ route('sekolah.update',$sekolah->uuid) }}">
                @method('PUT')
                @csrf
                <div class="grid grid-cols-1 sm:grid-cols-4 mt-5">
                    <div class="mb-2 col-span-3">
                        ...
                        <input type="text" id="nama" name="nama" class="@error('nama') bg-red-50 border border-red-500 text-red-900 placeholder-red-700 focus:ring-red-200 focus:border-red-500 @else bg-gray-50 border border-gray-300 text-gray-900 text-sm focus:ring-blue-500 focus:border-blue-500 @enderror block w-full p-2.5 rounded-lg" placeholder="Masukkan Nama Sekolah" value="{{ old('nama',$sekolah->nama) }}" />
                        @error('nama')
                    ...
                    <div class="mb-2 col-span-3">
                        ...
                        <input type="text" id="kode" name="kode" class="@error('kode') bg-red-50 border border-red-500 text-red-900 placeholder-red-700 focus:ring-red-200 focus:border-red-500 @else bg-gray-200 border border-gray-300 text-gray-900 text-sm focus:ring-blue-500 focus:border-blue-500 @enderror block w-full p-2.5 rounded-lg" disabled placeholder="Masukkan Kode Sekolah" value="{{ old('kode',$sekolah->kode) }}" />
                        @error('kode')
                            <p class="text-xs text-red-600 dark:text-red-500 mt-1"><span class="font-medium">Perhatian!</span> Wajib Diisi</p>
                        @enderror
                    </div>
