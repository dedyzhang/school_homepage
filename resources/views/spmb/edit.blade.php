...
@section('container')
    <div class="p-4 bg-white rounded-lg shadow-md">
        <h1 class="text-2xl font-bold">DAFTAR SPMB {{$sekolah->kode}}</h1>
        <p class="text-gray-600 italic">Halaman untuk MENDAFTARKAN SPMB MELALUI ADMIN</p>
        <div class="border-b border-b-gray-300 mt-3"></div>
    
    </div>
    <div class="p-4 mt-5 bg-white rounded-lg shadow-md">
        <form action="{{ route('spmb.update',$siswa->uuid) }}" method="POST">
            @csrf
                ...
                <div class="col-span-1 gap-3 grid grid-cols-1">
                    ...
                    <div class="form-group">
                        ...
                        <div class="flex">
                            <div class="flex items-center me-4">
                                <input id="lk" type="radio" value="l" name="jk" class="w-4 h-4 text-neutral-primary border-default-medium bg-neutral-secondary-medium rounded-full checked:border-brand focus:ring-2 focus:outline-none focus:ring-brand-subtle border border-default appearance-none" @if(@old('jk',$siswa_form['jk']) == 'l') checked @endif>
                                <label for="lk" class="select-none ms-2 text-sm font-medium text-heading">Laki-Laki</label>
                            </div>
                            <div class="flex items-center me-4">
                                <input id="pr" type="radio" value="p" name="jk" class="w-4 h-4 text-neutral-primary border-default-medium bg-neutral-secondary-medium rounded-full checked:border-brand focus:ring-2 focus:outline-none focus:ring-brand-subtle border border-default appearance-none" @if(@old('jk',$siswa_form['jk']) == 'p') checked @endif>
                    ...
                    @if(in_array('nisn',$formulir))
                        <div class="form-group">
                            ...
                            <input type="text" name="nisn" id="nisn" class="block w-full min-w-0 grow py-1.5 px-3 text-base @error('nisn') text-red-500 border-red-200 placeholder:text-red-800 @else text-gray-900 placeholder:text-gray-400 border-neutral-300 @enderror focus:outline-none sm:text-sm/6 rounded-lg outline-0 focus:border-indigo-500" placeholder="Masukkan NISN Siswa" value="{{old('nisn',$siswa_form['nisn'])}}" />
                            @error('nisn')
                                <p class="mt-1 text-[12px] text-red-700"><span class="font-medium">Perhatian!</span> Kolom ini wajib diisi.</p>
                            @enderror
                        </div>
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="tempat_lahir" id="tempat_lahir" class="block w-full min-w-0 grow py-1.5 px-3 text-base @error('tempat_lahir') text-red-500 border-red-200 placeholder:text-red-800 @else text-gray-900 placeholder:text-gray-400 border-neutral-300 @enderror focus:outline-none sm:text-sm/6 rounded-lg outline-0 focus:border-indigo-500" placeholder="Masukkan Tempat Lahir Siswa" value="{{old('tempat_lahir',$siswa_form['tempat_lahir'])}}" />
                        @error('tempat_lahir')
                            <p class="mt-1 text-[12px] text-red-700"><span class="font-medium">Perhatian!</span> Kolom ini wajib diisi.</p>
                        @enderror
                    </div>
                    <div class="form-group">
                        ...
                        <input type="date" name="tanggal_lahir" id="tanggal_lahir" class="block w-full min-w-0 grow py-1.5 px-3 text-base @error('tanggal_lahir') text-red-500 border-red-200 placeholder:text-red-800 @else text-gray-900 placeholder:text-gray-400 border-neutral-300 @enderror focus:outline-none sm:text-sm/6 rounded-lg outline-0 focus:border-indigo-500" placeholder="Masukkan Tanggal Lahir Siswa" value="{{old('tanggal_lahir',$siswa_form['tanggal_lahir'])}}" />
                        @error('tanggal_lahir')
                            <p class="mt-1 text-[12px] text-red-700"><span class="font-medium">Perhatian!</span> Kolom ini wajib diisi.</p>
                        @enderror
                    </div>
                    <div class="form-group">
                        ...
                        <select name="agama" id="agama" class="block w-full min-w-0 grow py-1.5 px-3 text-base @error('agama') text-red-500 border-red-200 placeholder:text-red-800 @else text-gray-900 placeholder:text-gray-400 border-neutral-300 @enderror focus:outline-none sm:text-sm/6 rounded-lg outline-0 focus:border-indigo-500">
                            ...
                            <option value="Buddha" @if(old('agama',$siswa_form['agama']) == "Buddha") selected @endif>Buddha</option>
                            <option value="Islam" @if(old('agama',$siswa_form['agama']) == "Islam") selected @endif>Islam</option>
                            <option value="Protestan" @if(old('agama',$siswa_form['agama']) == "Protestan") selected @endif>Kristen Protestan</option>
                            <option value="Katolik" @if(old('agama',$siswa_form['agama']) == "Katolik") selected @endif>Kristen Katolik</option>
                            <option value="Hindu" @if(old('agama',$siswa_form['agama']) == "Hindu") selected @endif>Hindu</option>
                            <option value="Konghucu" @if(old('agama',$siswa_form['agama']) == "Konghucu") selected @endif>Konghucu</option>
                        </select>
                        @error('agama')
                            <p class="mt-1 text-[12px] text-red-700"><span class="font-medium">Perhatian!</span> Kolom ini wajib diisi.</p>
                        @enderror
                    ...
                    @if(in_array('no_handphone',$formulir))
                        <div class="form-group">
                            ...
                            <input type="text" name="no_handphone" id="no_handphone" class="block w-full min-w-0 grow py-1.5 px-3 text-base @error('no_handphone') text-red-500 border-red-200 placeholder:text-red-800 @else text-gray-900 placeholder:text-gray-400 border-neutral-300 @enderror focus:outline-none sm:text-sm/6 rounded-lg outline-0 focus:border-indigo-500 mask-phone" placeholder="Masukkan No Handphone Siswa" value="{{old('no_handphone',$siswa_form['no_handphone'])}}" />
                            @error('no_handphone')
                                <p class="mt-1 text-[12px] text-red-700"><span class="font-medium">Perhatian!</span> Kolom ini wajib diisi.</p>
                            @enderror
                        </div>
                    ...
                    @if(in_array('pendidikan_ayah',$formulir))
                        <div class="form-group">
                            ...
                            <select name="pendidikan_ayah" id="pendidikan_ayah" class="block w-full min-w-0 grow py-1.5 px-3 text-base text-gray-900 placeholder:text-gray-400 focus:outline-none sm:text-sm/6 rounded-lg outline-0 focus:border-indigo-500 border-neutral-300">
                                <option value="">Pilih salah satu</option>
                                <option value="Tidak Sekolah" @if(old('pendidikan_ayah',$siswa_form['pendidikan_ayah']) == 'Tidak Sekolah') selected @endif>Tidak Sekolah</option>
                                <option value="Putus SD" @if(old('pendidikan_ayah',$siswa_form['pendidikan_ayah']) == 'Putus SD') selected @endif>Putus SD</option>
                                <option value="SD" @if(old('pendidikan_ayah',$siswa_form['pendidikan_ayah']) == 'SD') selected @endif>SD</option>
                                <option value="SMP" @if(old('pendidikan_ayah',$siswa_form['pendidikan_ayah']) == 'SMP') selected @endif>SMP</option>
                                <option value="SMA/SMK" @if(old('pendidikan_ayah',$siswa_form['pendidikan_ayah']) == 'SMA/SMK') selected @endif>SMA/SMK</option>
                                <option value="Strata 1 (S1)" @if(old('pendidikan_ayah',$siswa_form['pendidikan_ayah']) == 'Strata 1 (S1)') selected @endif>Strata 1 (S1)</option>
                                <option value="Strata 2 (S2)" @if(old('pendidikan_ayah',$siswa_form['pendidikan_ayah']) == 'Strata 2 (S2)') selected @endif>Strata 2 (S2)</option>
                                <option value="Strata 3 (S3)" @if(old('pendidikan_ayah',$siswa_form['pendidikan_ayah']) == 'Strata 3 (S3)') selected @endif>Strata 3 (S3)</option>
                            </select>
                        </div>
                    @endif
                    ...
                    @if(in_array('penghasilan_ayah',$formulir))
                        <div class="form-group">
                            ...
                            <select name="penghasilan_ayah" id="penghasilan_ayah" class="block w-full min-w-0 grow py-1.5 px-3 text-base text-gray-900 placeholder:text-gray-400 focus:outline-none sm:text-sm/6 rounded-lg outline-0 focus:border-indigo-500 border-neutral-300">
                                <option value="">Pilih salah satu</option>
                                <option value="Kurang dari Rp. 500.000" @if(old('penghasilan_ayah',$siswa_form['penghasilan_ayah']) == 'Kurang dari Rp. 500.000') selected @endif>Kurang dari Rp. 500.000</option>
                                <option value="Rp. 500.000 - Rp. 999.999" @if(old('penghasilan_ayah',$siswa_form['penghasilan_ayah']) == 'Rp. 500.000 - Rp. 999.999') selected @endif>Rp. 500.000 - Rp. 999.999</option>
                                <option value="Rp. 1.000.000 - Rp. 1.999.999" @if(old('penghasilan_ayah',$siswa_form['penghasilan_ayah']) == 'Rp. 1.000.000 - Rp. 1.999.999') selected @endif>Rp. 1.000.000 - Rp. 1.999.999</option>
                                <option value="Rp. 2.000.000 - Rp. 4.999.999" @if(old('penghasilan_ayah',$siswa_form['penghasilan_ayah']) == 'Rp. 2.000.000 - Rp. 4.999.999') selected @endif>Rp. 2.000.000 - Rp. 4.999.999</option>
                                <option value="Rp. 5.000.000 - Rp. 20.000.000" @if(old('penghasilan_ayah',$siswa_form['penghasilan_ayah']) == 'Rp. 5.000.000 - Rp. 20.000.000') selected @endif>Rp. 5.000.000 - Rp. 20.000.000</option>
                                <option value="Tidak Berpenghasilan" @if(old('penghasilan_ayah',$siswa_form['penghasilan_ayah']) == 'Tidak Berpenghasilan') selected @endif>Tidak Berpenghasilan</option>
                            </select>
                        </div>
                    @endif
                </div>
                ...
                <div class="col-span-1 gap-3 grid grid-cols-1 content-start">
                    ...
                    @if(in_array('nama_ibu',$formulir))
                        <div class="form-group">
                            ...
                            <input type="text" name="nama_ibu" id="nama_ibu" class="block w-full min-w-0 grow py-1.5 px-3 text-base text-gray-900 placeholder:text-gray-400 focus:outline-none sm:text-sm/6 rounded-lg outline-0 focus:border-indigo-500 border-neutral-300" placeholder="Masukkan Nama Ibu" value="{{ old('nama_ibu',$siswa_form['nama_ibu']) }}" />
                        </div>
                    @endif
                    @if(in_array('nik_ibu',$formulir))
                        <div class="form-group">
                            <label for="nik_ibu" class="block text-sm text-gray-800 mb-1">NIK Ibu</label>
                            <input type="text" name="nik_ibu" id="nik_ibu" class="block w-full min-w-0 grow py-1.5 px-3 text-base text-gray-900 placeholder:text-gray-400 focus:outline-none sm:text-sm/6 rounded-lg outline-0 focus:border-indigo-500 border-neutral-300" placeholder="Masukkan NIK Ibu" value="{{ old('nik_ibu',$siswa_form['nik_ibu']) }}" />
                        </div>
                    @endif
                    @if(in_array('ttl_ibu',$formulir))
                        <div class="form-group">
                            <label for="tempat_lahir_ibu" class="block text-sm text-gray-800 mb-1">Tempat Lahir Ibu</label>
                            <input type="text" name="tempat_lahir_ibu" id="tempat_lahir_ibu" class="block w-full min-w-0 grow py-1.5 px-3 text-base text-gray-900 placeholder:text-gray-400 focus:outline-none sm:text-sm/6 rounded-lg outline-0 focus:border-indigo-500 border-neutral-300" placeholder="Masukkan Tempat Lahir Ibu" value="{{ old('tempat_lahir_ibu',$siswa_form['tempat_lahir_ibu']) }}" />
                        </div>
                        <div class="form-group">
                            <label for="tanggal_lahir_ibu" class="block text-sm text-gray-800 mb-1">Tanggal Lahir Ibu</label>
                            <input type="date" name="tanggal_lahir_ibu" id="tanggal_lahir_ibu" class="block w-full min-w-0 grow py-1.5 px-3 text-base text-gray-900 placeholder:text-gray-400 focus:outline-none sm:text-sm/6 rounded-lg outline-0 focus:border-indigo-500 border-neutral-300" placeholder="Masukkan Tanggal Lahir Ibu" value="{{ old('tanggal_lahir_ibu',$siswa_form['tanggal_lahir_ibu']) }}" />
                        </div>
                    @endif
                    @if(in_array('pekerjaan_ibu',$formulir))
                        <div class="form-group">
                            <label for="pekerjaan_ibu" class="block text-sm text-gray-800 mb-1">Pekerjaan Ibu</label>
                            <input type="text" name="pekerjaan_ibu" id="pekerjaan_ibu" class="block w-full min-w-0 grow py-1.5 px-3 text-base text-gray-900 placeholder:text-gray-400 focus:outline-none sm:text-sm/6 rounded-lg outline-0 focus:border-indigo-500 border-neutral-300" placeholder="Masukkan Pekerjaan Ibu" value="{{ old('pekerjaan_ibu',$siswa_form['pekerjaan_ibu']) }}" />
                        </div>
                    @endif
                    @if(in_array('pendidikan_ibu',$formulir))
                        <div class="form-group">
                            ...
                            <select name="pendidikan_ibu" id="pendidikan_ibu" class="block w-full min-w-0 grow py-1.5 px-3 text-base text-gray-900 placeholder:text-gray-400 focus:outline-none sm:text-sm/6 rounded-lg outline-0 focus:border-indigo-500 border-neutral-300">
                                <option value="">Pilih salah satu</option>
                                <option value="Tidak Sekolah" @if(old('pendidikan_ibu',$siswa_form['pendidikan_ibu']) == 'Tidak Sekolah') selected @endif>Tidak Sekolah</option>
                                <option value="Putus SD" @if(old('pendidikan_ibu',$siswa_form['pendidikan_ibu']) == 'Putus SD') selected @endif>Putus SD</option>
                                <option value="SD" @if(old('pendidikan_ibu',$siswa_form['pendidikan_ibu']) == 'SD') selected @endif>SD</option>
                                <option value="SMP" @if(old('pendidikan_ibu',$siswa_form['pendidikan_ibu']) == 'SMP') selected @endif>SMP</option>
                                <option value="SMA/SMK" @if(old('pendidikan_ibu',$siswa_form['pendidikan_ibu']) == 'SMA/SMK') selected @endif>SMA/SMK</option>
                                <option value="Strata 1 (S1)" @if(old('pendidikan_ibu',$siswa_form['pendidikan_ibu']) == 'Strata 1 (S1)') selected @endif>Strata 1 (S1)</option>
                                <option value="Strata 2 (S2)" @if(old('pendidikan_ibu',$siswa_form['pendidikan_ibu']) == 'Strata 2 (S2)') selected @endif>Strata 2 (S2)</option>
                                <option value="Strata 3 (S3)" @if(old('pendidikan_ibu',$siswa_form['pendidikan_ibu']) == 'Strata 3 (S3)') selected @endif>Strata 3 (S3)</option>
                            </select>
                        </div>
                    @endif
                    @if(in_array('handphone_ibu',$formulir))
                        <div class="form-group">
                            ...
                            <input type="text" name="handphone_ibu" id="handphone_ibu" class="block w-full min-w-0 grow py-1.5 px-3 text-base text-gray-900 placeholder:text-gray-400 focus:outline-none sm:text-sm/6 rounded-lg outline-0 border-neutral-300 focus:border-indigo-500 mask-phone" placeholder="Masukkan Nomor Handphone Ibu" value="{{ old('handphone_ibu',$siswa_form['handphone_ibu']) }}" />
                        </div>
                    @endif
                    @if(in_array('penghasilan_ibu',$formulir))
                        <div class="form-group">
                            ...
                            <select name="penghasilan_ibu" id="penghasilan_ibu" class="block w-full min-w-0 grow py-1.5 px-3 text-base text-gray-900 placeholder:text-gray-400 focus:outline-none sm:text-sm/6 rounded-lg outline-0 focus:border-indigo-500 border-neutral-300">
                                <option value="">Pilih salah satu</option>
                                <option value="Kurang dari Rp. 500.000" @if(old('penghasilan_ibu',$siswa_form['penghasilan_ibu']) == 'Kurang dari Rp. 500.000') selected @endif>Kurang dari Rp. 500.000</option>
                                <option value="Rp. 500.000 - Rp. 999.999" @if(old('penghasilan_ibu',$siswa_form['penghasilan_ibu']) == 'Rp. 500.000 - Rp. 999.999') selected @endif>Rp. 500.000 - Rp. 999.999</option>
                                <option value="Rp. 1.000.000 - Rp. 1.999.999" @if(old('penghasilan_ibu',$siswa_form['penghasilan_ibu']) == 'Rp. 1.000.000 - Rp. 1.999.999') selected @endif>Rp. 1.000.000 - Rp. 1.999.999</option>
                                <option value="Rp. 2.000.000 - Rp. 4.999.999" @if(old('penghasilan_ibu',$siswa_form['penghasilan_ibu']) == 'Rp. 2.000.000 - Rp. 4.999.999') selected @endif>Rp. 2.000.000 - Rp. 4.999.999</option>
                                <option value="Rp. 5.000.000 - Rp. 20.000.000" @if(old('penghasilan_ibu',$siswa_form['penghasilan_ibu']) == 'Rp. 5.000.000 - Rp. 20.000.000') selected @endif>Rp. 5.000.000 - Rp. 20.000.000</option>
                                <option value="Tidak Berpenghasilan" @if(old('penghasilan_ibu',$siswa_form['penghasilan_ibu']) == 'Tidak Berpenghasilan') selected @endif>Tidak Berpenghasilan</option>
                            </select>
                        </div>
                    @endif
                </div>
                ...
                <div class="col-span-1 gap-3 grid grid-cols-1 content-start">
                    ...
                    @if(in_array('pendidikan_wali',$formulir))
                        <div class="form-group">
                            ...
                            <select name="pendidikan_wali" id="pendidikan_wali" class="block w-full min-w-0 grow py-1.5 px-3 text-base text-gray-900 placeholder:text-gray-400 focus:outline-none sm:text-sm/6 rounded-lg outline-0 focus:border-indigo-500 border-neutral-300">
                                <option value="">Pilih salah satu</option>
                                <option value="Tidak Sekolah" @if(old('pendidikan_wali',$siswa_form['pendidikan_wali']) == 'Tidak Sekolah') selected @endif>Tidak Sekolah</option>
                                <option value="Putus SD" @if(old('pendidikan_wali',$siswa_form['pendidikan_wali']) == 'Putus SD') selected @endif>Putus SD</option>
                                <option value="SD" @if(old('pendidikan_wali',$siswa_form['pendidikan_wali']) == 'SD') selected @endif>SD</option>
                                <option value="SMP" @if(old('pendidikan_wali',$siswa_form['pendidikan_wali']) == 'SMP') selected @endif>SMP</option>
                                <option value="SMA/SMK" @if(old('pendidikan_wali',$siswa_form['pendidikan_wali']) == 'SMA/SMK') selected @endif>SMA/SMK</option>
                                <option value="Strata 1 (S1)" @if(old('pendidikan_wali',$siswa_form['pendidikan_wali']) == 'Strata 1 (S1)') selected @endif>Strata 1 (S1)</option>
                                <option value="Strata 2 (S2)" @if(old('pendidikan_wali',$siswa_form['pendidikan_wali']) == 'Strata 2 (S2)') selected @endif>Strata 2 (S2)</option>
                                <option value="Strata 3 (S3)" @if(old('pendidikan_wali',$siswa_form['pendidikan_wali']) == 'Strata 3 (S3)') selected @endif>Strata 3 (S3)</option>
                            </select>
                        </div>
                    @endif
                    @if(in_array('handphone_wali',$formulir))
                        <div class="form-group">
                            ...
                            <input type="text" name="handphone_wali" id="handphone_wali" class="block w-full min-w-0 grow py-1.5 px-3 text-base text-gray-900 placeholder:text-gray-400 focus:outline-none sm:text-sm/6 rounded-lg outline-0 border-neutral-300 focus:border-indigo-500 mask-phone" placeholder="Masukkan Nomor Handphone Wali" value="{{ old('handphone_wali',$siswa_form['handphone_wali']) }}" />
                        </div>
                    @endif
                    @if(in_array('penghasilan_wali',$formulir))
                        <div class="form-group">
                            ...
                            <select name="penghasilan_wali" id="penghasilan_wali" class="block w-full min-w-0 grow py-1.5 px-3 text-base text-gray-900 placeholder:text-gray-400 focus:outline-none sm:text-sm/6 rounded-lg outline-0 focus:border-indigo-500 border-neutral-300">
                                <option value="">Pilih salah satu</option>
                                <option value="Kurang dari Rp. 500.000" @if(old('penghasilan_wali',$siswa_form['penghasilan_wali']) == 'Kurang dari Rp. 500.000') selected @endif>Kurang dari Rp. 500.000</option>
                                <option value="Rp. 500.000 - Rp. 999.999" @if(old('penghasilan_wali',$siswa_form['penghasilan_wali']) == 'Rp. 500.000 - Rp. 999.999') selected @endif>Rp. 500.000 - Rp. 999.999</option>
                                <option value="Rp. 1.000.000 - Rp. 1.999.999" @if(old('penghasilan_wali',$siswa_form['penghasilan_wali']) == 'Rp. 1.000.000 - Rp. 1.999.999') selected @endif>Rp. 1.000.000 - Rp. 1.999.999</option>
                                <option value="Rp. 2.000.000 - Rp. 4.999.999" @if(old('penghasilan_wali',$siswa_form['penghasilan_wali']) == 'Rp. 2.000.000 - Rp. 4.999.999') selected @endif>Rp. 2.000.000 - Rp. 4.999.999</option>
                                <option value="Rp. 5.000.000 - Rp. 20.000.000" @if(old('penghasilan_wali',$siswa_form['penghasilan_wali']) == 'Rp. 5.000.000 - Rp. 20.000.000') selected @endif>Rp. 5.000.000 - Rp. 20.000.000</option>
                                <option value="Tidak Berpenghasilan" @if(old('penghasilan_wali',$siswa_form['penghasilan_wali']) == 'Tidak Berpenghasilan') selected @endif>Tidak Berpenghasilan</option>
                            </select>
                        </div>
                    @endif
                </div>
                ...
                <div class="col-span-1 gap-3 grid grid-cols-1 content-start">
                    ...
                    @if(in_array('kps',$formulir))
                        <div class="form-group">
                            ...
                            <input type="text" name="kps" id="kps" class="block w-full min-w-0 grow py-1.5 px-3 text-base text-gray-900 placeholder:text-gray-400 focus:outline-none sm:text-sm/6 rounded-lg border-neutral-300 outline-0 focus:border-indigo-500" placeholder="Masukkan No KPS Siswa" value="{{old('kps',$siswa_form['kps'])}}" />
                        </div>
                    @endif
                    @if(in_array('kip',$formulir))
                        <div class="form-group">
                            <label for="kip" class="block text-sm text-gray-800 mb-1">No KIP ( Kartu Indonesia Pintar )</label>
                            <input type="text" name="kip" id="kip" class="block w-full min-w-0 grow py-1.5 px-3 text-base text-gray-900 placeholder:text-gray-400 focus:outline-none sm:text-sm/6 rounded-lg border-neutral-300 outline-0 focus:border-indigo-500" placeholder="Masukkan No KIP Siswa" value="{{old('kip',$siswa_form['kip'])}}" />
                        </div>
                    @endif
                    ...
                    @if(in_array('jenis_pendaftaran',$formulir))
                        <div class="form-group">
                            ...
                            <select name="jenis_pendaftaran" id="jenis_pendaftaran" class="block w-full min-w-0 grow py-1.5 px-3 text-base focus:outline-none sm:text-sm/6 rounded-lg @error('jenis_pendaftaran') text-red-500 border-red-200 placeholder:text-red-800 @else text-gray-900 placeholder:text-gray-400 border-neutral-300 @enderror outline-0 focus:border-indigo-500">
                                <option value="">Pilih salah satu</option>
                                <option value="Siswa Baru" @if(old('jenis_pendaftaran',$siswa_form['jenis_pendaftaran']) == 'Siswa Baru') selected @endif>Siswa Baru</option>
                                <option value="Mutasi" @if(old('jenis_pendaftaran',$siswa_form['jenis_pendaftaran']) == 'Mutasi') selected @endif>Siswa Mutasi/Pindahan</option>
                            </select>
            ...
            <div class="grid grid-cols-1 my-10 gap-5">
