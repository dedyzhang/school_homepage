            ...
            <form method="post" action="{{ route('user.update',$user->uuid)}}">
                ...
                <div class="grid grid-cols-1 sm:grid-cols-4 mt-5">
                    <div class="mb-2 col-span-3">
                        ...
                        <input type="text" id="name" name="name" class="@error('name') bg-red-50 border border-red-500 text-red-900 placeholder-red-700 focus:ring-red-200 focus:border-red-500 @else bg-gray-50 border border-gray-300 text-gray-900 text-sm focus:ring-blue-500 focus:border-blue-500 @enderror rounded-lg block w-full p-2.5" placeholder="Masukkan Nama Anda" value="{{ old('name',$user->name) }}" />
                        @error('name')
                    ...
                    <div class="mb-2 col-span-3">
                        ...
                        <input type="number" id="nik" name="nik" class="@error('nik') bg-red-50 border border-red-500 text-red-900 placeholder-red-700 focus:ring-red-200 focus:border-red-500 @else bg-gray-200 border border-gray-300 text-gray-900 text-sm focus:ring-blue-500 focus:border-blue-500 @enderror rounded-lg disabled block w-full p-2.5" placeholder="Masukkan Nomor Induk Karyawan Anda" value="{{ old('nik',$user->username) }}" />
                        @error('nik')
